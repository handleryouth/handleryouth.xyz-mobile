    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <Paragraph>
          ...
          like to learn something new and project is my way to learn something
          new in website. I&apos;ve done a lot of challenges and i am always
          trying to learn something new. Another way for me to learn is by
          sharing code with others. It&apos;s fun !
        </Paragraph>
        <Paragraph>
          I created this website and mobile app to share projects which of
          course can be an idea for other frontend developers who want to learn
          about frontend web development. I hope you enjoy it.
        </Paragraph>
        ...
        <Section
          ...
          body={
            <>
              <Paragraph>
                I use the following technologies to build this App.
              </Paragraph>
